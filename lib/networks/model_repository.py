...
class Resnet18_8s_modified(nn.Module):
    def __init__(self, ver_dim, seg_dim, fcdim=256, s8dim=128, s4dim=64, s2dim=32, raw_dim=32):
        ...
        # TODO
        feature_size = 1024
        self.mapping_net = nn.Sequential(*[MappingBasicBlock(raw_dim, feature_size), MappingBasicBlock(feature_size, raw_dim, downsample=nn.Conv2d(feature_size, raw_dim, 1))])
